...
class io_board_py_t(object):
    ...
    NAME_MAP = {
        ...
        "ADC1"           : lambda board : board.adcs[0],
        "ADC2"           : lambda board : board.adcs[1],
        "ADC3"           : lambda board : board.adcs[2],
        "ADC4"           : lambda board : board.adcs[3],
        "ADC5"           : lambda board : board.adcs[4],
        "ADC6"           : lambda board : board.adcs[5],
        "ADC7"           : lambda board : board.adcs[6],
        "ADC8"           : lambda board : board.adcs[7],
        "ADC9"           : lambda board : board.adcs[8],
        "ADC10"          : lambda board : board.adcs[9],
    }
